 ...
 */
public class Chapter5_3Fragment extends Fragment {

    // Variables declared for the class
    public static final String ARG_PAGE = "ARG_PAGE";
    TextToSpeech voice;

    public Chapter5_3Fragment() {
        // Required empty public constructor
    }


    // Method that creates the Chapter5_3 Fragment takes in arguement
    // page used to display correct page
    public static Chapter5_3Fragment newInstance(int page) {
        ...
        Chapter5_3Fragment fragment = new Chapter5_3Fragment(); // declaring objec fragment  that is a instance of Chapter5_3 Fragment
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_chapter5_3, container, false);
        ...
        final String text = getResources().getString(R.string.chapter5_3_1text) +" "+
                firstCharacter +" "+ getResources().getString(R.string.chapter5_3_2text) +" "+
                secondCharacter +" "+ getResources().getString(R.string.chapter5_3_3text);
        ...
        TextView textView = (TextView) rootView.findViewById(R.id.chapter5_3_Text);
