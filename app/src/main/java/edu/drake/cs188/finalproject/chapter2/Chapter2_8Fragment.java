...
public class Chapter2_8Fragment extends Fragment {
    // Variables declared for the class
    public static final String ARG_PAGE = "ARG_PAGE";
    TextToSpeech voice;

    public Chapter2_8Fragment() {
    ...
    public static Chapter2_8Fragment newInstance(int page) {
        ...
        Chapter2_8Fragment fragment = new Chapter2_8Fragment(); // declaring object fragment  that is a instance of Chapter2_1 Fragment
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_chapter2_8, container, false);
        ...
        final String text = getResources().getString(R.string.chapter2_8_1text) +" "+ firstCharacter +" "+
                getResources().getString(R.string.chapter2_8_2text)
                +" "+ secondCharacter +" "+ getResources().getString(R.string.chapter2_8_3text);
        ...
        TextView textView = (TextView) rootView.findViewById(R.id.chapter2_8_Text);
