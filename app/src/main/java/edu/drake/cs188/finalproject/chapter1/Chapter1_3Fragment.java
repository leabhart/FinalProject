...
public class Chapter1_3Fragment extends Fragment {
    // Variables declared for the class
    public static final String ARG_PAGE = "ARG_PAGE";
    TextToSpeech voice;

    public Chapter1_3Fragment() {
        // Required empty public constructor
    }


    // Method that creates the Chapter1_3 takes in arguement
    // page used to display correct page
    public static Chapter1_3Fragment newInstance(int page) {
        ...
        Chapter1_3Fragment fragment = new Chapter1_3Fragment(); // declaring object fragment  that is a instance of Chapter1_3
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_chapter1_3, container, false);
        ...
        final String text = firstCharacter +" "+ getResources().getString(R.string.chapter1_3_1text) +" "+ firstCharacter +" "+ getResources().getString(R.string.chapter1_3_2text) ;
        ...
        TextView textView = (TextView) rootView.findViewById(R.id.chapter1_3_Text);
