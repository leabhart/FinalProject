...
public class Chapter2_6Fragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        final String text = getResources().getString(R.string.chapter2_6_1text);
         ...
         * craig: sound button
         */
        ImageView policeSiren = (ImageView) rootView.findViewById(R.id.doggie);
        policeSiren.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                playSound(R.raw.dogbarking);
            }
        });
