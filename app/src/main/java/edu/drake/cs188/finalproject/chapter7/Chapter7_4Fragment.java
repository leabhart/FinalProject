 ...
 */
public class Chapter7_4Fragment extends Fragment {
    // Variables declared for the class
    public static final String ARG_PAGE = "ARG_PAGE";
    TextToSpeech voice;

    public Chapter7_4Fragment() {
        // Required empty public constructor
    }


    // Method that creates the Chapter7_3 Fragment takes in arguement
    // page used to display correct page
    public static Chapter7_4Fragment newInstance(int page) {
        ...
        Chapter7_4Fragment fragment = new Chapter7_4Fragment(); // declaring objec fragment  that is a instance of Chapter7_3 Fragment
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_chapter7_4, container, false);
        rootView.setBackground(ContextCompat.getDrawable(getActivity(), R.drawable.chapter7_4));
        ...
        final String text = firstCharacter +" "+ getResources().getString(R.string.chapter7_4_1textMoral) +" "+
                getResources().getString(R.string.chapter7_4_2textMoral) +" "+
                firstCharacter +" "+ getResources().getString(R.string.chapter7_4_3textMoral) +" "+
                firstCharacter + " " + getResources().getString(R.string.chapter7_4_2text) + " " +
                secondCharacter + " " + getResources().getString(R.string.chapter7_4_3text);
