...
public class Chapter8_1Fragment extends Fragment {
    // Variables declared for the class
    public static final String ARG_PAGE = "ARG_PAGE";

    public Chapter8_1Fragment() {
        // Required empty public constructor
    }


    // Method that creates the Chapter8_1 Fragment takes in arguement
    // page used to display correct page
    public static Chapter8_1Fragment newInstance(int page) {
        ...
        Chapter8_1Fragment fragment = new Chapter8_1Fragment(); // declaring object fragment  that is a instance of Chapter8_1 Fragment
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_chapter8_1, container, false);
