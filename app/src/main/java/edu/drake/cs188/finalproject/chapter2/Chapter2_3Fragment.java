...
public class Chapter2_3Fragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        final String text = getResources().getString(R.string.chapter2_3_1text) + secondCharacter +" "+
                getResources().getString(R.string.chapter2_3_2text) +" "+ firstCharacter +" "+
                getResources().getString(R.string.chapter2_3_3text);
