...
public class Chapter2_11Fragment extends Fragment {
    // Variables declared for the class
    public static final String ARG_PAGE = "ARG_PAGE";

    public Chapter2_11Fragment() {
    ...
    public static Chapter2_11Fragment newInstance(int page) {
        ...
        Chapter2_11Fragment fragment = new Chapter2_11Fragment(); // declaring objec fragment  that is a instance of Chapter2_2 Fragment
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_chapter2_11, container, false);
