 ...
 */
public class Chapter3_6Fragment extends Fragment {
    // Variables declared for the class
    public static final String ARG_PAGE = "ARG_PAGE";
    TextToSpeech voice;

    public Chapter3_6Fragment() {
    ...
    public static Chapter3_6Fragment newInstance(int page) {
        ...
        Chapter3_6Fragment fragment = new Chapter3_6Fragment(); // declaring objec fragment  that is a instance of Chapter3_6 Fragment
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_chapter3_6, container, false);
        rootView.setBackground(ContextCompat.getDrawable(getActivity(), R.drawable.chapter3_6));
        ...
        final String text = getResources().getString(R.string.chapter3_6_1text);
        ...
        TextView textView = (TextView) rootView.findViewById(R.id.chapter3_6_Text);
