...
public class Chapter2_4Fragment extends Fragment {
    // Variables declared for the class
    public static final String ARG_PAGE = "ARG_PAGE";
    TextToSpeech voice;

    public Chapter2_4Fragment() {
    ...
    public static Chapter2_4Fragment newInstance(int page) {
        ...
        Chapter2_4Fragment fragment = new Chapter2_4Fragment(); // declaring object fragment  that is a instance of Chapter2_1 Fragment
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_chapter2_4, container, false);
        ...
        final String text = getResources().getString(R.string.chapter2_4_1text) +" "+ secondCharacter +" "+
                getResources().getString(R.string.chapter2_4_2text);
        ...
        TextView textView = (TextView) rootView.findViewById(R.id.chapter2_4_Text);
