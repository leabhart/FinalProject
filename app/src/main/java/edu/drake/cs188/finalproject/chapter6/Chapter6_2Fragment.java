...
public class Chapter6_2Fragment extends Fragment {
    // Variables declared for the class
    public static final String ARG_PAGE = "ARG_PAGE";

    public Chapter6_2Fragment() {
        // Required empty public constructor
    }


    // Method that creates the Chapter6_2 Fragment takes in arguement
    // page used to display correct page
    public static Chapter6_2Fragment newInstance(int page) {
        ...
        Chapter6_2Fragment fragment = new Chapter6_2Fragment(); // declaring objec fragment  that is a instance of Chapter6_2 Fragment
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_chapter6_2, container, false);
        ...
        if (decision == 1){
            String text = firstCharacter +" "+ getResources().getString(R.string.chapter6_2_1textGame) +" "+
...
//            rootView.setBackground(ContextCompat.getDrawable(getActivity(), R.drawable.chapter6_2_1));
        ...
        if(decision == 2){
            String text = firstCharacter +" "+ getResources().getString(R.string.chapter6_2_1textBook)
