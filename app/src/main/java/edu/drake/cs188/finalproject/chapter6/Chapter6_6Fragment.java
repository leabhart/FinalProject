...
public class Chapter6_6Fragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        final String text = getResources().getString(R.string.chapter6_6_1text) +" "+ firstCharacter +" "+
                getResources().getString(R.string.chapter6_6_2text) +" "+ secondCharacter +" "+
                getResources().getString(R.string.chapter6_6_3text);
