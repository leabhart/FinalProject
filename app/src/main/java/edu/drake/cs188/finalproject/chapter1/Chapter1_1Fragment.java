...
public class Chapter1_1Fragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        rootView.setBackground(ContextCompat.getDrawable(getActivity(), R.drawable.chapter1_1));
        ...
        final String text = getResources().getString(R.string.chapter1_1_1text) +" "+ firstCharacter +" "+ getResources().getString(R.string.chapter1_1_2text)
                +" "+ firstCharacter + getResources().getString(R.string.chapter1_1_3text);
