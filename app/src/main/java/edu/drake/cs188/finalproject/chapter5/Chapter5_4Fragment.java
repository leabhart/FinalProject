...
public class Chapter5_4Fragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        rootView.setBackground(ContextCompat.getDrawable(getActivity(), R.drawable.chapter5_4));
        ...
        final String text = firstCharacter +" "+ getResources().getString(R.string.chapter5_4_1text) +" "+ secondCharacter +" "+
