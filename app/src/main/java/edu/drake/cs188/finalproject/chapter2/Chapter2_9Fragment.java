...
public class Chapter2_9Fragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        final String text = getResources().getString(R.string.chapter2_9_1text) +" "+ secondCharacter +" "+
                getResources().getString(R.string.chapter2_9_2text)
                +" "+ firstCharacter +" "+ getResources().getString(R.string.chapter2_9_3text);
        ...
        TextView textView = (TextView) rootView.findViewById(R.id.chapter2_9_Text);
