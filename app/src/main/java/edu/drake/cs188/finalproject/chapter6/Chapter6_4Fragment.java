 ...
 */
public class Chapter6_4Fragment extends Fragment {

    // Variables declared for the class
    public static final String ARG_PAGE = "ARG_PAGE";
    TextToSpeech voice;

    public Chapter6_4Fragment() {
        // Required empty public constructor
    }


    // Method that creates the Chapter6_4 Fragment takes in arguement
    // page used to display correct page
    public static Chapter6_4Fragment newInstance(int page) {
        ...
        Chapter6_4Fragment fragment = new Chapter6_4Fragment(); // declaring objec fragment  that is a instance of Chapter6_4 Fragment
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_chapter6_4, container, false);
        ...
        final String text = getResources().getString(R.string.chapter6_4_1text) +" "+ firstCharacter +" "+
                getResources().getString(R.string.chapter6_4_2text) +" "+ secondCharacter +" "+
                getResources().getString(R.string.chapter6_4_3text);

        rootView.setBackground(ContextCompat.getDrawable(getActivity(), R.drawable.chapter6_4));
        ...
        TextView textView = (TextView) rootView.findViewById(R.id.chapter6_4_Text);
