...
public class Chapter2_5Fragment extends Fragment {
    // Variables declared for the class
    public static final String ARG_PAGE = "ARG_PAGE";
    TextToSpeech voice;

    public Chapter2_5Fragment() {
    ...
    public static Chapter2_5Fragment newInstance(int page) {
        ...
        Chapter2_5Fragment fragment = new Chapter2_5Fragment(); // declaring object fragment  that is a instance of Chapter2_1 Fragment
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_chapter2_5, container, false);
        ...
        final String text = getResources().getString(R.string.chapter2_5_1text);
        ...
        TextView textView = (TextView) rootView.findViewById(R.id.chapter2_5_Text);
